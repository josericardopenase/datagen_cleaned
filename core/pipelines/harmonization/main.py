from pipelines.dependencies.ai.discriminative_ai.background_removers.mock_background_remover import MockBackgroundRemover
from pipelines.dependencies.ai.utils.dataset_savers import YoloDatasetSaver
from pipelines.dependencies.gen_ai.image_generators.sthocastic_image_generator import StochasticImageGenerator
from pipelines.dependencies.gen_ai.image_harmonizers import LibcomImageHarmonizer
from pipelines.dependencies.utils.logging.loggers.terminal_logger import TerminalLogger
from pipelines.dependencies.api.mmseg_api import MMSegAPI
from pipelines.dependencies.ai.discriminative_ai.point_extractors.mmseg_point_extractor import MMSegPointExtractor
from pipelines.dependencies.gen_ai.image_inpainters.dalle2_image_inpainter import Dalle2ImageInpainter
from pipelines.dependencies.ai.quality_evaluators.dataset_similarity_evaluators import \
    FIDDatasetSimilarityEvaluator
from pipelines.dependencies.ai.quality_evaluators.text_image_similarity_evaluators.clip_text_image_similarity_evaluator import \
    CLIPTextImageSimilarityEvaluator
from pipelines.dependencies.ai.quality_evaluators.image_similarity_evaluators.lpips_image_similarity_evaluator import \
...
from pipelines.dependencies.ai.quality_evaluators.quality_evaluator import QualityEvaluator
